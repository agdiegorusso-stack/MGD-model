...
class MgdMath09 {
  ...
  static double ollivierRicci({
    ...
    final distance = shortest(a, b);
    if (distance <= 1e-9 || !distance.isFinite) return 0.0;
    ...
    // With maxBallSize this is curvature of the truncated uniform measures.
    return 1.0 - totalCost / distance;
  }
}
